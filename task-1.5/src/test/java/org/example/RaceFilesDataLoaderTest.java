...
class RaceFilesDataLoaderTest {
    private static final String SEPARATOR = System.lineSeparator();
    private RaceFilesDataLoader raceFilesDataLoader;

    @BeforeEach
    void setup() {
        raceFilesDataLoader = new RaceFilesDataLoader();
    }
    ...
    public void characterCounting_returnStringWithCountedUniqueCharacters_whenInputIsSpaces() {
        String expected = "1. Sebastian Vettel | FERRARI | 01:04.415" + SEPARATOR +
                ...
                "__________________________________________________________" + SEPARATOR +
                ...
                "19. Kevin Magnussen | HAAS FERRARI | 01:13.393" + SEPARATOR;
        String actual = raceFilesDataLoader.orderRacers();
